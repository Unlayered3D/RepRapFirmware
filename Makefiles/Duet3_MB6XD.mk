...
DUET3MB6XD_FREERTOS_LIB := $(WORKSPACE)/FreeRTOS/SAME70/libFreeRTOS.a
DUET3MB6XD_COREN2G_LIB := $(WORKSPACE)/CoreN2G/SAME70_CAN_SDHC_USB_RTOS/libCoreN2G.a
DUET3MB6XD_RRFLIBS_LIB := $(WORKSPACE)/RRFLibraries/SAME70_RTOS/libRRFLibraries.a
DUET3MB6XD_CANLIB_LIB := $(WORKSPACE)/CANlib/SAME70_RTOS/libCANlib.a
DUET3MB6XD_LIBTINYUSB_LIB := $(WORKSPACE)/LibTinyusb/SAME70/libLibTinyusb.a
DUET3MB6XD_MBEDTLS_LIB := $(WORKSPACE)/LibMbedTls/SAME70/libLibMbedTls.a
...
DUET3MB6XD_CPP_EXCL := /libcpp/ /libc/ /DuetNG/ /DuetM/ /Pccb/ /Display/ /Duet3Mini/ \
...
DUET3MB6XD_CPP_SRCS := $(foreach f,$(DUET3MB6XD_CPP_SRCS),$(if $(strip $(foreach e,$(DUET3MB6XD_CPP_EXCL),$(findstring $(e),$(f)))),,$(f)))

DUET3MB6XD_C_EXCL := /libc/ /DuetNG/ /DuetM/ /Pccb/ /Display/ /Duet3Mini/ \
	/Hardware/SAM4E/ /Hardware/SAME5x/ /Hardware/SAM4S/ /Networking/W5500Ethernet/ \
...
DUET3MB6XD_C_SRCS := $(foreach f,$(DUET3MB6XD_C_SRCS),$(if $(strip $(foreach e,$(DUET3MB6XD_C_EXCL),$(findstring $(e),$(f)))),,$(f)))
