...
DUET3MB6XD_CPP_EXCL := $(SAME70_FAMILY_CPP_EXCL)
DUET3MB6XD_CPP_SRCS := $(shell find $(DUET3MB6XD_SRC_DIR) -name '*.cpp')
DUET3MB6XD_CPP_SRCS := $(call EXCLUDE_PATHS,$(DUET3MB6XD_CPP_SRCS),$(DUET3MB6XD_CPP_EXCL))

DUET3MB6XD_C_EXCL := $(SAME70_FAMILY_C_EXCL)
DUET3MB6XD_C_SRCS := $(shell find $(DUET3MB6XD_SRC_DIR) -name '*.c')
DUET3MB6XD_C_SRCS := $(call EXCLUDE_PATHS,$(DUET3MB6XD_C_SRCS),$(DUET3MB6XD_C_EXCL))
