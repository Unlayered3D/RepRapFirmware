...
DUET3CAN0_CPP_EXCL := /libcpp/ /libc/ /DuetNG/ /DuetM/ /Pccb/ /Display/ /Duet3Mini/ \
...
DUET3CAN0_CPP_SRCS := $(foreach f,$(DUET3CAN0_CPP_SRCS),$(if $(strip $(foreach e,$(DUET3CAN0_CPP_EXCL),$(findstring $(e),$(f)))),,$(f)))

DUET3CAN0_C_EXCL := /libc/ /DuetNG/ /DuetM/ /Pccb/ /Display/ /Duet3Mini/ \
	/Hardware/SAM4E/ /Hardware/SAME5x/ /Hardware/SAM4S/ /Networking/W5500Ethernet/ \
...
DUET3CAN0_C_SRCS := $(foreach f,$(DUET3CAN0_C_SRCS),$(if $(strip $(foreach e,$(DUET3CAN0_C_EXCL),$(findstring $(e),$(f)))),,$(f)))
