...
DUET3CAN0_CPP_EXCL := $(SAME70_FAMILY_CPP_EXCL)
DUET3CAN0_CPP_SRCS := $(shell find $(DUET3CAN0_SRC_DIR) -name '*.cpp')
DUET3CAN0_CPP_SRCS := $(call EXCLUDE_PATHS,$(DUET3CAN0_CPP_SRCS),$(DUET3CAN0_CPP_EXCL))

DUET3CAN0_C_EXCL := $(SAME70_FAMILY_C_EXCL)
DUET3CAN0_C_SRCS := $(shell find $(DUET3CAN0_SRC_DIR) -name '*.c')
DUET3CAN0_C_SRCS := $(call EXCLUDE_PATHS,$(DUET3CAN0_C_SRCS),$(DUET3CAN0_C_EXCL))
