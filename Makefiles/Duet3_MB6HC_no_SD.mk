...
DUET3NOSD_FREERTOS_LIB := $(WORKSPACE)/FreeRTOS/SAME70/libFreeRTOS.a
DUET3NOSD_COREN2G_LIB := $(WORKSPACE)/CoreN2G/SAME70_CAN_SDHC_USB_RTOS/libCoreN2G.a
DUET3NOSD_RRFLIBS_LIB := $(WORKSPACE)/RRFLibraries/SAME70_RTOS/libRRFLibraries.a
DUET3NOSD_CANLIB_LIB := $(WORKSPACE)/CANlib/SAME70_RTOS/libCANlib.a
DUET3NOSD_LIBTINYUSB_LIB := $(WORKSPACE)/LibTinyusb/SAME70/libLibTinyusb.a
DUET3NOSD_MBEDTLS_LIB := $(WORKSPACE)/LibMbedTls/SAME70/libLibMbedTls.a
...
DUET3NOSD_CPP_EXCL := /libcpp/ /libc/ /DuetNG/ /DuetM/ /Pccb/ /Display/ /Duet3Mini/ \
...
DUET3NOSD_CPP_SRCS := $(foreach f,$(DUET3NOSD_CPP_SRCS),$(if $(strip $(foreach e,$(DUET3NOSD_CPP_EXCL),$(findstring $(e),$(f)))),,$(f)))

DUET3NOSD_C_EXCL := /libc/ /DuetNG/ /DuetM/ /Pccb/ /Display/ /Duet3Mini/ \
	/Hardware/SAM4E/ /Hardware/SAME5x/ /Hardware/SAM4S/ /Networking/W5500Ethernet/ \
...
DUET3NOSD_C_SRCS := $(foreach f,$(DUET3NOSD_C_SRCS),$(if $(strip $(foreach e,$(DUET3NOSD_C_EXCL),$(findstring $(e),$(f)))),,$(f)))
