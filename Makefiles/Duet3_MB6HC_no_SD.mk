...
DUET3NOSD_CPP_EXCL := $(SAME70_FAMILY_CPP_EXCL)
DUET3NOSD_CPP_SRCS := $(shell find $(DUET3NOSD_SRC_DIR) -name '*.cpp')
DUET3NOSD_CPP_SRCS := $(call EXCLUDE_PATHS,$(DUET3NOSD_CPP_SRCS),$(DUET3NOSD_CPP_EXCL))

DUET3NOSD_C_EXCL := $(SAME70_FAMILY_C_EXCL)
DUET3NOSD_C_SRCS := $(shell find $(DUET3NOSD_SRC_DIR) -name '*.c')
DUET3NOSD_C_SRCS := $(call EXCLUDE_PATHS,$(DUET3NOSD_C_SRCS),$(DUET3NOSD_C_EXCL))
